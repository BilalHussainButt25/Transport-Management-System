<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Insert.aspx.cs" Inherits="project.Insert1" %>
...
.error-message {
 ...
 body{
            ...
            <tr>
                    <td><asp:Button CssClass="btn btn-primary" runat="server" ID="btninsert" Text="Insert" OnClick="btninsert_Click"  /></td>
                </tr>
                <tr><td>
